  ...
  public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
    ...
    if (args[0].equalsIgnoreCase("startNew")){
      ...
      if (!quests.contains(args[1])){
        ...
        p.sendMessage((String) yamlManager.getConfig("messages.info.quests.start", p, true));
      } else {
      ...
      if (quests.contains(args[1])){
        ...
        p.sendMessage((String) yamlManager.getConfig("messages.info.quests.disband", p, true));
      } else {
